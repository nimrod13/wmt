...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="well">
            <form class="bs-example form-horizontal report-form" action="/report/user" method="post">
                <fieldset>
                    <legend>Rapoarte per utilizator</legend>
    ...
    <?php if( isset($usr) && isset($batches) ): ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="bs-example table-responsive">
                    <table class="table table-striped table-bordered bootstrap-datatable" id="datatable-user">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#datatable-user thead tr').each( function () {
                    this.insertBefore( nCloneTh, this.childNodes[0] );
                } );
                $('#datatable-user tbody tr').each( function () {
                    this.insertBefore(  nCloneTd.cloneNode( true ), this.childNodes[0] );
                } );

                /* Initialse DataTables, with no sorting on the 'details' column */
                var oTable = $('#datatable-user').dataTable( {
                 ...
                 */
                $( document ).on('click', "#datatable-user tbody td img",function () {
                    ...
                    else
                    {
                        ...
                        var data = 'job_date='+job_date+'&user_id='+user_id;
                        $.ajax({
                            type: "POST",
                            url: url,
                            async: true,
