    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="well">
                ...
                <form class="bs-example form-horizontal edit-daily-activity" action="/activity/daily/edit" method="post">
                    <fieldset>
                        <legend>Actualizare Activitate Zilnica - <?= date('d.m.Y'); ?></legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="li" name="li" disabled>
                            </div>
                        </div>
