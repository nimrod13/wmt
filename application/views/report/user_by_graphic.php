...
<?php if( isset($usr) && isset($batches) ): ?>
    <div id="gu-graph-wrapper">
            ...
            <script type="text/javascript" class="code">
                ...
                var line1=[
                    ...
                    <?php
                        ...
                        $client_tmp = new Client( $batch->client_id );
                        $client_tmp = $client_tmp->name;
                        echo "['$batch->job_date', $batch->no_bills, '$batch->no_bills - $client_tmp'],";
                        ?>
                    <?php endforeach; ?>
                ];
                ...
                var line2=[
                    <?php
                        foreach( $batches as $batch )
                        {
                            $client_tmp = new Client( $batch->client_id );
                            $client_tmp = $client_tmp->name;
                            echo "['$batch->job_date', $batch->errors, '$batch->errors - $client_tmp'],";
                        }
                    ?>
                ];
            </script>
        ...
        foreach( $batches as $batch ){
            ...
            $client_tmp = new Client( $batch->client_id );
            $b_names[ $job_date ] = $client_tmp->name;
        }
        ?>
            ...
            <script type="text/javascript" class="code">
                ...
                var line1=[
                    ...
                    <?php $name = $b_names[$date]; ?>
                    <?php echo "['$date', $no_bills, '$no_bills - $name'],";?>
                    <?php endforeach; ?>
                ];
                ...
                var line2=[
                    ...
                    <?php $name = $b_names[$date]; ?>
                    <?php echo "['$date', $no_errors, '$no_bills - $name'],";?>
                    <?php endforeach; ?>
                ];
        ...
        <script type="text/javascript" class="code">
            ...
            // display graphic with height max
